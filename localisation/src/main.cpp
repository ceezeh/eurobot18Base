...
int main() {
	 ...
	 */
	double sigma_pos [3] = {0.01, 0.01, 0.0833}; // GPS measurement uncertainty coefficient [x [m], y [m], theta [rad]]
	...
	for (int i = 0; i < num_time_steps; ++i) {
		...
		vector<BeaconObs> noisy_observations;
		BeaconObs obs;
